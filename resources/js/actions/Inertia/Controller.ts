...
* @route '/visa-ai'
*/
const Controllerc3e19c7c39a601f8f31eba3a79059b48 = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: Controllerc3e19c7c39a601f8f31eba3a79059b48.url(options),
    method: 'get',
})

Controllerc3e19c7c39a601f8f31eba3a79059b48.definition = {
    methods: ["get","head"],
    url: '/visa-ai',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/visa-ai'
*/
Controllerc3e19c7c39a601f8f31eba3a79059b48.url = (options?: RouteQueryOptions) => {
    return Controllerc3e19c7c39a601f8f31eba3a79059b48.definition.url + queryParams(options)
}
...
* @route '/visa-ai'
*/
Controllerc3e19c7c39a601f8f31eba3a79059b48.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: Controllerc3e19c7c39a601f8f31eba3a79059b48.url(options),
    method: 'get',
})
...
* @route '/visa-ai'
*/
Controllerc3e19c7c39a601f8f31eba3a79059b48.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: Controllerc3e19c7c39a601f8f31eba3a79059b48.url(options),
    method: 'head',
})
...
* @route '/visa-ai'
*/
const Controllerc3e19c7c39a601f8f31eba3a79059b48Form = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: Controllerc3e19c7c39a601f8f31eba3a79059b48.url(options),
    method: 'get',
})
...
* @route '/visa-ai'
*/
Controllerc3e19c7c39a601f8f31eba3a79059b48Form.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: Controllerc3e19c7c39a601f8f31eba3a79059b48.url(options),
    method: 'get',
})
...
* @route '/visa-ai'
*/
Controllerc3e19c7c39a601f8f31eba3a79059b48Form.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: Controllerc3e19c7c39a601f8f31eba3a79059b48.url({
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
...
Controllerc3e19c7c39a601f8f31eba3a79059b48.form = Controllerc3e19c7c39a601f8f31eba3a79059b48Form
/**
* @see \Inertia\Controller::__invoke
* @see vendor/inertiajs/inertia-laravel/src/Controller.php:13
